...
COLUMN_ALIASES = {
    "student_id": ["student_id", "id", "student id", "studentid", "roll_no", "roll_number", "roll no", "admission_no", "admission_number", "roll_number", "roll no.", "admission no", "admission no."],
    "name": ["name", "student_name", "student name", "full_name", "full name", "studentname", "students_name", "student", "student_name_full"],
    "gender": ["gender", "sex", "student_gender", "student gender"],
    "age": ["age", "student_age", "student age", "years", "year", "birth_year", "birth year"],
    "department": ["department", "dept", "branch", "course", "program", "section", "class"],
    "semester": ["semester", "sem", "term", "year", "academic_year", "academic year", "class_year", "class"],
    "attendance_percentage": ["attendance_percentage", "attendance", "attendance %", "attendance percentage", "attn", "attendance_pct", "attend", "attend_pct", "attendance %"],
    "math_score": ["math_score", "math", "maths", "mathematics", "math_score", "math_marks", "math marks", "math_score", "mathematics_score"],
    "science_score": ["science_score", "science", "physics", "chemistry", "biology", "science_score", "science_marks", "phy", "chem", "bio"],
    "programming_score": ["programming_score", "programming", "coding", "programming_score", "programming_marks", "computer", "cs", "computer_science"],
    "english_score": ["english_score", "english", "language", "english_score", "english_marks", "lang"],
    "assignment_score": ["assignment_score", "assignment", "assignments", "assignment_score", "assignment_marks", "project", "projects"],
    "internal_score": ["internal_score", "internal", "internal_marks", "internal_score", "quiz", "quizzes", "midterm", "mid_term", "mid term", "internal_mark"],
    "final_exam_score": ["final_exam_score", "final", "final_exam", "final exam", "final_score", "finalexam", "end_term", "endterm", "final examination", "final examination score"],
    "study_hours_per_week": ["study_hours_per_week", "study_hours", "study hours", "hours_per_week", "study_time", "study_time_per_week", "study hrs", "study_hours_weekly"],
    "extracurricular": ["extracurricular", "extra_curricular", "activities", "hobbies", "sports", "clubs", "extra curricular"],
    "internet_access": ["internet_access", "internet", "internet access", "connectivity", "network", "internet_connection"],
    "location": ["location", "city", "address", "region", "area", "residence", "hometown", "place", "city_name"],
}
