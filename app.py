...
st.sidebar.markdown(
    ...
    <div style="text-align: center; padding: 0.5rem 0 1.5rem 0;">
        <h1 style="font-size: 1.5rem; margin: 0; background: linear-gradient(135deg, #6366f1, #8b5cf6, #06b6d4); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
            <span style="-webkit-text-fill-color: initial;">📊</span> Analytics
        </h1>
...
st.markdown(
    ...
    <div style="margin-bottom: 2rem;">
        <h1 style="font-size: 2.5rem; font-weight: 800; margin: 0; background: linear-gradient(135deg, #6366f1, #8b5cf6, #06b6d4); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
            <span style="-webkit-text-fill-color: initial;">🎓</span> Student Performance Analytics
        </h1>
